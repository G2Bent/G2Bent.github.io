import{_ as s,o as a,c as n,U as l}from"./chunks/framework.bcba648a.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"articles/gulp的使用.md","filePath":"articles/gulp的使用.md"}'),p={name:"articles/gulp的使用.md"},e=l(`<h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>随着前端诸如webpack，rollup，vite的发展，gulp感觉似乎好像被取代了。其实并没有，只不过它从台前退居到了幕后。我们仍然可以在很多项目中看到它的身影，比如elementplus、vant等。现在gulp更多的是做流程化的控制。</p><blockquote><p>比如我们要把一个大象放进冰箱里就需要 打开冰箱门-&gt;把大象放进冰箱-&gt;关上冰箱门，这就是一个简单的流程，使用gulp就可以规定这些流程，将这个流程自动化。</p></blockquote><p>所以我们可以使用它在项目开发过程中自动执行常见任务。比如打包一个组件库，我们可能要移除文件、copy文件，打包样式、打包组件、执行一些命令还有一键打包多个package等等都可以由gulp进行自定义流程的控制，非常的方便。</p><p>本文将主要介绍gulp的一些常用功能</p><h2 id="安装gulp" tabindex="-1">安装gulp <a class="header-anchor" href="#安装gulp" aria-label="Permalink to &quot;安装gulp&quot;">​</a></h2><p>首先全局安装gulp的脚手架</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">npm install --global gulp-cli</span></span></code></pre></div><p>然后我们新建文件夹gulpdemo，然后执行 <strong>npm init -y</strong>,然后在这个项目下安装本地依赖gulp</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">npm install gulp -D</span></span></code></pre></div><p>此时我们gulp便安装好了，接下来我们在根目录下创建<strong>gulpfile.js</strong>文件，当gulp执行的时候会自动寻找这个文件。</p><h2 id="创建一个任务task" tabindex="-1">创建一个任务Task <a class="header-anchor" href="#创建一个任务task" aria-label="Permalink to &quot;创建一个任务Task&quot;">​</a></h2><p>每个gulp任务（task）都是一个异步的JavaScript函数，此函数是一个可以接收callback作为参数的函数，或者返回一个Promise等异步操作对象，比如创建一个任务可以这样写</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">exports.default = (cb) =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">};</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">exports.default = lessTask;</span></span></code></pre></div><p>然后我们执行gulp命令就会发现dist/style/index.css</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">.wrap {</span></span>
<span class="line"><span style="color:#A6ACCD;">  color: #fff;</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><p>我们还可以给css加前缀</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">npm install gulp-autoprefixe -D</span></span></code></pre></div><p>将我们的src/style/index.less改为</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">@color: #fff;</span></span>
<span class="line"><span style="color:#A6ACCD;">.wrap {</span></span>
<span class="line"><span style="color:#A6ACCD;">  color: @color;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">};</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">exports.default = lessTask;</span></span></code></pre></div><p>处理后的dist/style/index.css就变成了</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">.wrap {</span></span>
<span class="line"><span style="color:#A6ACCD;">  color: #fff;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">};</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">exports.default = browserTask;</span></span></code></pre></div><p>此时改动src下的文件浏览器便会刷新。</p><p>下面我们将index.html引入dist/style/index.css的样式,然后来模拟一个简单的构建流</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&lt;!DOCTYPE html&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">&lt;html lang=&quot;en&quot;&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">  &lt;head&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">    &lt;meta charset=&quot;UTF-8&quot; /&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">    &lt;meta http-equiv=&quot;X-UA-Compatible&quot; content=&quot;IE=edge&quot; /&gt;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  &lt;/body&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">&lt;/html&gt;</span></span></code></pre></div><p>此时我们的流程是 <strong>编译less文件</strong>-&gt;<strong>将css写入dist/style</strong>-&gt;<strong>触发页面更新</strong></p><p>我们<strong>gulpfile.js</strong>可以这样写</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const { src, dest } = require(&quot;gulp&quot;);</span></span>
